...
export const RosterComponent = ({item}) => {
    ...
    return (
        <View style={{width: "100%"}}>
            <Image style={{width: "100%", height: Dimensions.get("window").width/2}} source={{uri: img_url}}></Image>
            {/* <View style={{padding: 20}}>
                <Text style={{textAlign: "center", color: "#f4f4f4", fontFamily: 'Roboto_400Regular', fontSize: 20}}>See More</Text>
            </View> */}
            <Text style={{marginTop: "5%", textAlign: "center", color: "#f4f4f4"}}>This is a short caption of the image</Text>
        </View>
    )
}
